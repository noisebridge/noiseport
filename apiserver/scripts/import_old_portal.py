...
for o in old:
    ...
    if o.status == "Contractor":
        print(
            "Skipping contractor member #{} - {} {}".format(
    ...
    models.Member.objects.create(
        photo_small=small, photo_medium=medium, photo_large=large, **new
    )
    print("Imported member #{} - {} {}".format(o.id, o.first_name, o.last_name))
...
for o in old:
    ...
    print("Imported transaction #{} - {} {}".format(o.id, o.member_id, o.category))
...
for o in old:
    ...
    print("Imported card #{} - {} {}".format(o.id, o.card_number, o.notes))
...
for o in old:
    ...
    print("Imported course #{} - {}".format(o.id, new["name"]))
...
for o in old:
    ...
    new["datetime"] = datetime.datetime.now().replace(tzinfo=zoneinfo.ZoneInfo("UTC"))

    models.Session.objects.create(**new)
    print("Imported session #{} - {} {}".format(o.id, o.instructor, new["course"]))
...
for o in old:
    ...
    print("Imported training #{} - {} {}".format(o.id, new["session"], o.member_id))
