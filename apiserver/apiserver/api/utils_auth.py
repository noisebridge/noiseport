...
def set_discourse_password(data):
    ...
    return auth_api(
        secrets.DISCOURSE_AUTH_API_URL + "set-discourse-password", data=auth_data
    )
...
def add_discourse_group_members(group_name, usernames):
    ...
    return auth_api(
        secrets.DISCOURSE_AUTH_API_URL + "add-discourse-group-members", json=json
    )
...
def remove_discourse_group_members(group_name, usernames):
    ...
    return auth_api(
        secrets.DISCOURSE_AUTH_API_URL + "remove-discourse-group-members", json=json
    )
...
def change_discourse_username(username, new_username):
    ...
    return auth_api(
        secrets.DISCOURSE_AUTH_API_URL + "change-discourse-username", data=data
    )
